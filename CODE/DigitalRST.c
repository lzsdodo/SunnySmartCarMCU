...
#pragma DATA_SEG DigitalRST_DATA       /* Select data segment "DigitalRST_DATA" */
#pragma CODE_SEG DigitalRST_CODE
#pragma CONST_SEG DigitalRST_CONST     /* Constant section for this module */
