...
#pragma DATA_SEG MotRigPWM_DATA        /* Select data segment "MotRigPWM_DATA" */
...
{
  /* Calculate new value according to the given ratio: PWMDTY45 = (PWMPER45 * (dword)RatioStore + 0x8000) / 0xFFFF; */
...
{
  /* PWMCNT45: PWMCNT45=0 */
  setReg16(PWMCNT45, 0x00U);           /* Reset Counter */ 
  ...
  /* PWMDTY45: PWMDTY45=0x0F9F */
  setReg16(PWMDTY45, 0x0F9FU);         /* Store initial value to the duty-compare register */ 
  /* PWMPER45: PWMPER45=0x0FA0 */
  setReg16(PWMPER45, 0x0FA0U);         /* and to the period register */ 
  /* PWMCLK: PCLK5=0 */
  clrReg8Bits(PWMCLK, 0x20U);          /* Select clock source */ 
  /* PWME: PWME5=1 */
