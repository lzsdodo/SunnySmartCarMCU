...
#pragma DATA_SEG FIFOWRST_DATA         /* Select data segment "FIFOWRST_DATA" */
#pragma CODE_SEG FIFOWRST_CODE
#pragma CONST_SEG FIFOWRST_CONST       /* Constant section for this module */
